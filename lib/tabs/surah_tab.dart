...
import 'package:al_quran/screens/detail_screen.dart';
  ...
  Widget _surahitem({required Surah surah, required BuildContext context}) => GestureDetector(
    ...
    onTap: () {
      Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => DetailScreen(noSurat: surah.nomor,)));
    },
    child: Padding(
      ...
      child: Row(
        children: [
          Stack(
            children: [SvgPicture.asset('assets/svgs/nomor-surah.svg'),
            SizedBox(
              height: 36,
              width: 36,
              child: Center(
